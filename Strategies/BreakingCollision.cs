...
{
    public class BreakingColision: ICollision
    {
        public void ResolveCollision(Entity entity, Entity other)
        {
            if (entity is BreakingWall a)
            {
                ...
                float widthReduction = a.Width * a.reductionAmount;
                float heightReduction = a.Height * a.reductionAmount;
